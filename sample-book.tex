...
%\usepackage{units} % commented out, using siunitx instead

% Typesets the font size, leading, and measure in the form of 10/12x26 pc.
\newcommand{\measure}[3]{#1/#2$\times$\SI{#3}{pc}}
...
\begin{table}[h]
  \begin{center}
    ...
    \begin{tabular}{lcl}
      ...
      Block quote & \measure{9}{12}{24} & Block indent (left and right) by \SI{1}{pc} \\
